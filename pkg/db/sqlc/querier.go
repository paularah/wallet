...
type Querier interface {
	...
	CreateFunding(ctx context.Context, arg CreateFundingParams) (Funding, error)
	...
	GetFunding(ctx context.Context, id int64) (Entry, error)
	...
	GetWalletFunding(ctx context.Context, arg GetWalletFundingParams) (Entry, error)
	ListTransfers(ctx context.Context, arg ListTransfersParams) ([]Transfer, error)
	ListWalletEntries(ctx context.Context, arg ListWalletEntriesParams) (Entry, error)
	ListWalletFunding(ctx context.Context, walletID int64) (Entry, error)
